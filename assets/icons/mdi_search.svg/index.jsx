...
const  mdi_search = props => (
    <svg xmlns="http://www.w3.org/2000/svg" width={props.width || "24px"} height={props.height || "16px"} fill={props.fill || "none"} viewBox={props.viewBox || "0 0 24 16"}>
