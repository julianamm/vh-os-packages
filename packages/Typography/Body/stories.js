...
storiesOf('typography|Body/Reverse', module)
  .add('xs', () => (
    <div style={{ background: Color.gradient.d, padding: "24px" }}>
  ...
  .add('sm', () => (
    <div style={{ background: Color.gradient.h, padding: "24px" }}>
  ...
  .add('lg', () => (
    <div style={{ background: Color.gradient.v, padding: "24px" }}>
